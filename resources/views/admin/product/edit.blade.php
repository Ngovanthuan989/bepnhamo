                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control formatPrice" name="origin_price" placeholder="Giá sản phẩm" min="1" value="{{$product->origin_price}}">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">Giá</label>
                                <input type="text" class="form-control formatPrice" name="price" placeholder="Giá sản phẩm"  value="{{$product->price}}" />
                            </div>
...
{{--                                    @endphp--}}
{{--                                    <input type="datetime-local" class="form-control pull-right" name="deal_end" value="{{ date_format($date,"Y-m-d\TH:i") }}">--}}
{{--                                </div>--}}
{{--                                <input type="text" class="form-control formatPrice" name="price_deal" placeholder="Giá deal" value="{{$product->price_deal}}">--}}
{{--                                <!-- /.input group -->--}}
{{--                            </div>--}}
